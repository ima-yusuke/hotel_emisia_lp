<article class="flex flex-col md:flex-row justify-center items-center bg-white gap-10 w-[90%] md:w-[70%] p-8 border border-solid border-gray-600 outline outline-4 outline-main-color rounded-lg">
    @if($flag=="true")
